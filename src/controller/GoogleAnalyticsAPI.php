...
class GoogleAnalyticsAPI {
    ...
    public function getWebProperties() {
        ...
        $data = $this->curl(self::WEBPROPERTIES_URL, array('access_token' => $this->accessToken));
    ...
    public function getProfiles() {
        ...
        $data = $this->curl(self::PROFILES_URL, array('access_token' => $this->accessToken));
        return json_decode($data, $this->assoc);
    ...
    public function getAccounts() {
        ...
        $data = $this->curl(self::ACCOUNTS_URL, array('access_token' => $this->accessToken));
        return json_decode($data, $this->assoc);
    ...
    public function getPropertiesById($id) {
        ...
        $data = $this->curl("https://www.googleapis.com/analytics/v3/management/accounts/$id/webproperties/", array('access_token' => $this->accessToken));
        return json_decode($data, $this->assoc);
    ...
    public function getProfileById($id,$webPropertyId) {
        ...
        $data = $this->curl("https://www.googleapis.com/analytics/v3/management/accounts/$id/webproperties/$webPropertyId/profiles", array('access_token' => $this->accessToken));
        return json_decode($data, $this->assoc);
    ...
    public function getEvents($params=array()) {
        ...
        $defaults = array(
            ...
            'filter' => 'ga:eventCategory==ABTest'
        );
        $_params = array_merge($defaults, $params);
        return $this->_query($_params);
    ...
    protected function _query($params=array()){
        ...
        $data = $this->curl(self::API_URL, $queryParams);
        return json_decode($data, $this->assoc);

    }

    public function curl($url, $params=array(), $post=false) {
...
class GoogleOauthService extends GoogleOauth {
    ...
    public function getAccessToken($data=null) {
        ...
        $auth = $this->curl(GoogleOauth::TOKEN_URL, $params, true);
...
class GoogleOauthWeb extends GoogleOauth {
    ...
    public function revokeAccess($token) {
        ...
        $data = $this->curl(self::REVOKE_URL, $params);
        return json_decode($data, $this->assoc);
    }
